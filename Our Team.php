        ...
        <ul class="topnav" id="myTopnav">
            ...
            <section id="Team" class="bg-light-gray">
				...
				<!-- Team Members Row -->
						...
						<tr>
							<td>
								<img  src="./static/keith.jpg" class="img-responsive"  style="border-radius: 25px; width:5cm; height:4.5cm;">
							</td>
						...
						<tr>
							<td>
								<img  src="./static/nasrin.jpg" class="img-responsive"  style="border-radius: 25px; width:5cm; height:4.8cm;">
							</td>
							...
							<br>
								...
								<br>
									Nasrin is a Ph.D. student and Graduate Research and Teaching Assistant in Industrial and Systems Engineering Department 
						...
						<tr>
							<td>
								<img  src="./static/moh.jpg" class="img-responsive"  style="border-radius: 25px; width:770px; height:170px;">
							</td>
							...
							<tr>
							<td>
								<img  src="./static/meg.jpg" class="img-responsive"  style="border-radius: 25px; width:5cm; height:4.8cm;">
							</td>
			...
			<tr>
							<td>
								<img  src="./static/sss.png" class="img-responsive" style="border-radius: 25px; width:170px; height:170px;">
							</td>
						...
						<tr>
							<td>
								<img  src="./static/lab.jpg" class="img-responsive"  style="border-radius: 25px; width:170px; height:170px;">
							</td>
						...
						<tr>
							<td>
								<img  src="./static/cel.jpg" class="img-responsive"  style="border-radius: 25px; width:170px; height:170px;">
							</td>
